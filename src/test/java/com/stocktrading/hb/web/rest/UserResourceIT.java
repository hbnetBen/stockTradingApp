...
import com.stocktrading.hb.domain.Authority;
...
public class UserResourceIT {
    ...
    public void getUser() throws Exception {
        ...
        assertThat(cacheManager.getCache(UserRepository.USERS_BY_LOGIN_CACHE).get(user.getUsername())).isNull();
        ...
        assertThat(cacheManager.getCache(UserRepository.USERS_BY_LOGIN_CACHE).get(user.getUsername())).isNotNull();
    }
