...
@SpringBootTest(classes = {StockTradingApp.class}, webEnvironment= SpringBootTest.WebEnvironment.DEFINED_PORT)
@WebAppConfiguration
public class Swagger2MarkupTest {
    ...
    private String outputDirForFormat(String format) throws IOException {
        return new File(projectDir, "docs/" + format).getAbsolutePath();
    }
}
